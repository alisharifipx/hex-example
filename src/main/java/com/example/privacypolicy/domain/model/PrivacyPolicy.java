package com.example.privacypolicy.domain.model;
...
public record PrivacyPolicy(
     ...
     */
    public static PrivacyPolicy createNew(String content, LocalDate effectiveFrom, LocalDate effectiveTo) {
    ...
    public PrivacyPolicy update(String newContent, LocalDate newFrom, LocalDate newTo) {
        return new PrivacyPolicy(this.id, this.version + 1, newContent, this.createdDate, newFrom, newTo);
    }
